...
#######################
## ETAPE 5
# AFFICHER LE MSG "PERSONNAGE ($name) CREER"2
...
<div class="w-100 mt-5">
    <form action="" method="POST" class="form-group">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name='atk' placeholder="Atk">
        </div>
        <div class="form-group col-md-4">
    ...
    if (!empty($_POST)){
        ...
        $pv = $_POST["pv"];
        $type = $_POST["type"];
        $stmt = $pdo->prepare('INSERT INTO personnage(name,atk,pv,type_id) VALUES ("'.$name.'",'.$atk.','.$pv.',(SELECT id FROM types WHERE name LIKE "'.$type.'"))');
        $stmt->execute();
